...
Public Class MortgageDoc
    ...
    Private Sub WriteCondoDeedData()
        ...
        Catch ex As Exception
            amountStr = ""
        End Try
        cmdString = "UPDATE instrumentmasterflat SET Amount = '" + amountStr + "',DeedType='C' WHERE InstrumentNo = " + CStr(PendingDeedInstrument)
        fmMain.dg.RunCommand(cmdString)
    End Sub
    Private Function SameName(ByVal Name1 As String, ByVal Name2 As String) As Boolean
        ...
        If Name1array(0).Contains(Trim(Name2)) Then
            Return True
        End If
