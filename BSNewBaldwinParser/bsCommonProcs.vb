...
Public Module bsCommonProcs
    ...
    Public Const BALDWINURL As String = "http://www.deltacomputersystems.com/cgi-iia5/IIMCGI05?HTMCNTY=AL05&HTMBASE=C&HTMKEY="
    Public Const BALDWINURL2 As String = "&HTMSUBMIT=Submit"
    ...
    Public Sub CheckAndRotate(ByVal CurrInst As String, ByVal TableName As String)
        ...
        Dim fName As String = "c:\ScannedDocs\" + Trim(CurrInst) + ".tif.txt"
        ...
        If TableName = "J" And CountyID = 0 Then
            If Not s.ToUpper.Contains("DEFENDANT") Then
                ConvertFile(CurrInst, True)
            End If
        End If
    End Sub

    Public Sub ConvertFile(ByVal CurrInst As String, Optional ByVal TableName As String = "", Optional ByVal Rotate As Boolean = False)
        ...
        fName = "c:\ScannedDocs\" + Trim(CurrInst) + ".tif"
        ...
        If TableName = "ST" Then
            Try
                ...
                fName = fName + "crp.tif"
                bmp.Save(fName, Imaging.ImageFormat.Tiff)
                bmp.Dispose()
    ...
    Public Function DontSwap(ByVal s As String) As Boolean
        Dim dsArray As New ArrayList
        Dim dr As MySqlDataReader = fmMain.dg.GetDataReader("SELECT word FROM dontswap")
        While dr.Read
            dsArray.Add(" " + dr(0))
        End While
        fmMain.dg.KillReader(dr)
        For i = 0 To dsArray.Count - 1
            If s.ToUpper.Contains(dsArray(i).ToString.ToUpper) Then
                Return True
            End If
        Next
        Return False
    ...
    Public Function SwapNames(ByVal nameStr As String) As String
        ...
        For i = 0 To AllNames.Count - 1
            ...
            If i = 0 And i < AllNames.Count Then
                SwapNames = SwapNames + AllNames(i) + " and "
            Else
                SwapNames = SwapNames + " " + AllNames(i)
            End If
        Next
    End Function
    ...
    Public Function SwapName(ByVal nameStr As String) As String
        ...
        If DontSwap(nameStr) Then Return nameStr
    ...
    Public Function isForeclosure(ByVal instNo As String) As Boolean
        If Not System.IO.File.Exists("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt") Then Return False
        Dim fStream As New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt")
        Dim line As String
            ...
            While Not fStream.EndOfStream
                ...
                If line.ToUpper.Contains("INSTRUMENT NUMBER") Then
                    ...
                    For i = 0 To UBound(strArray)
                        ...
                        strArray(i) = strArray(i).Replace(",", "")
                        strArray(i) = strArray(i).Replace(".", "")
                        If IsNumeric(strArray(i)) And (Trim(strArray(i)).Length = 6 Or Trim(strArray(i)).Length = 7 And Not strArray(i).Contains("$")) Then
                            Return strArray(i)
                        End If
                    Next
                End If
                ...
                If line.ToUpper.Contains("INSTRUMENT") And Not line.ToUpper.Contains("PREPARED BY") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(",", "")
                ...
                If line.ToUpper.Contains("JNSTRUMENT NUMBER") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(",", "")
                ...
                If line.ToUpper.Contains("NUMBER #") Then
                    ...
                    Next
                End If
                If line.ToUpper.Contains("INST #") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(",", "")
                    ...
                    Next
                End If
                If line.ToUpper.Contains("INST NO") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(",", "")
                    ...
                    Next
                End If
                If line.ToUpper.Contains("JUDGMENT BOOK") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(",", "")
                ...
                If line.ToUpper.Contains("BOOK ") Then
                    strArray = line.Split(" ")
                    For i = 0 To UBound(strArray)
                        strArray(i) = strArray(i).Replace("#", "")
                        strArray(i) = strArray(i).Replace(".", "")
    ...
    Public Function GetFODesc(ByVal instNo As String, ByVal grantor As String, ByVal grantee As String) As String
        ...
        fStream = New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt")
        line = fStream.ReadLine
        While Not fStream.EndOfStream
            line = fStream.ReadLine
            If Not gotAuctioneer Then
    ...
    Public Function GetAmount(ByVal instNo As String, Optional ByVal GetLargest As Boolean = False, Optional ByVal AddAmts As Boolean = False, Optional ByVal isTaxDoc As Boolean = False, Optional ByVal isRegions As Boolean = False) As String
        ...
        If Not System.IO.File.Exists("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt") Then
            Return "0.0"
        End If
        fStream = New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt")
        Dim amtStr As String = ""
    ...
    Public Function GetUSKindTax(ByVal instNo As String)
        Try
            ...
            Dim fStream As New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".png.txt")
            Dim tDes As String = ""
            Dim line As String = fStream.ReadLine
            While Not fStream.EndOfStream
                line = fStream.ReadLine
    ...
    Public Function GetALKindTax(ByVal instNo As String)
        ...
        Try
            Dim fStream As System.IO.StreamReader
            Try
                If System.IO.File.Exists("c:\ScannedDocs\" + Trim(Str(instNo)) + "crp.tif.txt") Then
                    fStream = New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + "crp.tif.txt")
                Else
                    fStream = New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt")
                End If
            ...
            While Not fStream.EndOfStream
                line = fStream.ReadLine
                If line.ToUpper.Contains("UNEMPLOYMENT") Then
                    Return "Unemployment"
                End If
                If line.ToUpper.Contains("TYPE OF TAX") Then
                    'line = fStream.ReadLine
    ...
    Public Function GetALTaxAddress(ByVal instNo As String)
        ...
        Try
            ...
            While Not fStream.EndOfStream
                ...
                If line.ToUpper.Contains("UNEMPLOYMENT") Then
                    isUILien = True
                    If isUILien And line.Contains("VS") Then
                        Dim lines() As String
                        line = fStream.ReadLine()
                        lines = line.Split(" ")
                        While Not isDone
                            For i = 0 To UBound(lines)
                                If IsNumeric(lines(i)) Then
                                    isDone = True
                                End If
                                tDes += line
                            Next
    ...
    Public Function GetALTaxAmount(ByVal instNo As String) As String
        ...
        line = Regex.Replace(line, "\)", " ")
        Dim matches As MatchCollection
        matches = Regex.Matches(line, "!~!\d*,*\.*\d{2}\s")
        For i = 0 To matches.Count - 1
            tAmts.Add(Regex.Replace(matches(i).Value, "!~!", ""))
        Next
        Return GetLargestAmt(tAmts)
    ...
    Public Function GetUSTaxAmount(ByVal instNo As String) As String
        ...
        Try
            Dim fStream As System.IO.StreamReader
            fStream = New System.IO.StreamReader("c:\ScannedDocs\" + Trim(Str(instNo)) + ".png.txt")
            Dim testAmt As Decimal = 0.0
            Dim line As String = fStream.ReadLine

            While Not fStream.EndOfStream
                line = fStream.ReadLine
                If line.ToUpper.Contains("BALDWIN COUNTY TOTAL") Then
                    line = fStream.ReadLine
                    line = fStream.ReadLine
    ...
    Public Function GetBCJudgeCase(ByVal instNo As String) As String
        ...
        While Not fStream.EndOfStream
            line = fStream.ReadLine
            If line.ToUpper.Contains("CV ") Or line.ToUpper.Contains("DR ") Or line.ToUpper.Contains("SM ") Or line.ToUpper.Contains("SN") Or line.ToUpper.Contains("DV") Then
                line = line.Replace("SN", "SM")
                line = line.Replace("Document Type: COJ CERTIFICATE OF JUDGMENT ", "")
                Return Trim(line)
            End If
        End While
        Return "ureadable"
    ...
    Public Function GetCaseNo(ByVal instNo As String) As String
        If Not System.IO.File.Exists("c:\ScannedDocs\" + Trim(Str(instNo)) + ".tif.txt") Then Return "Unreadable"
